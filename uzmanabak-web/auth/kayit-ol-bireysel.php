            ...
            <div class="card-body px-lg-5 py-lg-5">
              ...
              <div class="form-group">
                  <div class="input-group input-group-merge input-group-alternative mb-3">
                    ...
                    <input class="form-control" name="name" placeholder="Adınız" type="text">
                    <input type="hidden" name="x" value="registerbus">
                  ...
                  <div class="input-group input-group-merge input-group-alternative mb-3">
                    ...
                    <input class="form-control" name="surname" placeholder="Soyadınız" type="text">
                  </div>
                <div class="form-group">
                  <div class="input-group input-group-merge input-group-alternative mb-3">
                    <div class="input-group-prepend">
